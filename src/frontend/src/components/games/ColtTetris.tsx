...
const ColtTetris: React.FC = () => {
  ...
  const getSpeed = useCallback(
    () => Math.max(100, 500 - Math.floor(linesRef.current / 5) * 40),
    [],
  );
    ...
    <div className="flex flex-col items-center gap-4">
      <div className="flex items-center gap-6 font-display text-sm tracking-wider">
        <span className="text-muted-foreground">
          SCORE: <span style={{ color: "#aa00ff" }}>{displayScore}</span>
        </span>
        <span className="text-muted-foreground">
          LINES: <span className="text-neon-cyan">{displayLines}</span>
        </span>
        <span className="text-muted-foreground">
        ...
        {gameState === "dead" && (
          ...
          >
            ...
            <p className="font-body text-muted-foreground mb-1">
              Score:{" "}
              <span style={{ color: "#aa00ff" }} className="font-bold">
                {displayScore}
              </span>
            </p>
